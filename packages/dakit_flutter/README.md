...
Flutter platform integrations for DAKit. It adapts mature plugins to the
platform-neutral interfaces exported by `dakit_core`:
...
For ordinary clients, `DAKitOAuthClient` assembles these adapters into a complete
